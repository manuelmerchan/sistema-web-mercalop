...
<div class="container delimitador">
  <div class="contenedor">
                ...
                <form name="formulario1" class="form3" action="app/guardarTipoCaso.php" method="POST">
                    ...
                    <div class="row">
                      <div class="col-md-12 content_cajas">
                          ...
                          <input class="form_input" type="text" id="tipo_caso" name="tipo_caso" required onkeypress="return sololetras(event)" placeholder="Escriba Tipo de Caso" onpaste="return false;">
                      </div>
...
$(document).on('click','#guardar', function(){
  // var valr= $(this).val();
  var valr= document.getElementById('tipo_caso').value;
  if(valr!=""){
    buscar_tipo_caso(valr);
  }else{
    const Toast = Swal.mixin({
        ...
        <script>
            ...
            <div class="cont_tabla">
              <table class="tabla">
                ...
                <tr>
                  <?php
                    $consulta=mysqli_query($con,"SELECT * FROM tipo_caso ORDER BY id_tipo_caso DESC");
                  ...
                  <td><div class="cont_tbn_tb">
                      <a href="ingreso_detalle_tipo_caso.php?id=<?php echo $row['id_tipo_caso'] ?>">
                        <button type="button" title="Agregar detalles" class="btn btn-default asignar" name="button">
