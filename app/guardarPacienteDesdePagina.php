<?php
	...
	include('../ENVIAR_CORREOS/envClavePacienteWeb.php');
	...
	$guardar2=mysqli_query($con,"INSERT INTO usuario (usuario_nombre, usuario_clave, user_id, tipo_usuario) VALUES ('$usuario', '$clave', '$id', '$tipo_usuario')") or die ("error".mysqli_error());

	mysqli_close($con);
	header("Location:../../registro_nuevo_paciente.php");
