<?php
	...
	$guardar_seguimiento = mysqli_query($con,"INSERT INTO evolucion (evolucion_fechai, evolucion_fecham, evolucion_horai, evolucion_horaf, evolucion_presion, evolucion_temperatura, evolucion_frespiratoria, evolucion_fcardiaca, evolucion_saturacion, evolucion_peso, evolucion_talla, evolucion_imc, evolucion_diagnostico, evolucion_evolucion, evolucion_observacion, evolucion_recomendacion, cita_id) VALUES ('$fecha', '$fecha', '$horai', '$horaf', '$presion', '$temperatura', '$frecuenciar', '$frecuenciac', '$saturacion', '$peso', '$talla', '$imc', '$diagnostico', '$evolucion', '$observaciones', '$recomendaciones', '$idcita')") or die ("error".mysqli_error());
