...
$consulta=mysqli_query($con,"SELECT * from cotizacion order by id_cotizacion DESC");
$nurow=mysqli_num_rows($consulta);
if ($nurow>0) {
  $row=mysqli_fetch_array($consulta);
  $num_cot=$row['num_cotizacion'];
  $num_f=$num_cot;
  $num_f+=1;
}else{
  $num_f=1;
...
<div class="container delimitador">
  <div class="contenedor">
                ...
                <form class="form" action="app/guardarCotizacion.php" method="POST" enctype="multipart/form-data">
                    <div class="form_header">
                        <h2 class="form_titulo">INGRESO DE COTIZACIÓN</h2>
                    </div>
...
$(function() {
  $("#clientes").customselect();
                      ...
                      <div class="col-md-12 content_cajas">
                            ...
                            <select class="form_input custom-select" id="clientes" name="clientes" required>
                              <option value="" >-Seleccionar-</option>
                              <?php $consulta4=mysqli_query($con,"SELECT * from clientes where id_estado='1' order by apellidos ASC"); //id_clientes!='1' and 
                                while($row4=mysqli_fetch_array($consulta4)){
                                echo "<option value='".$row4['id_clientes']."'>"; echo $row4['cedula']." - ".$row4['nombres']." ".$row4['apellidos']; echo "</option>"; } ?> </select>
                        </div><br><br><br><br><br>
...
$(function() {
  $("#servicios").customselect();
                      ...
                      <div class="col-md-8 content_cajas">
                          ...
                          <select class="form_input custom-select" id="servicios" name="servicios" required>
                          <!-- <select class="form_input" id="servicios" name="servicios" required> -->
                            <option value="" >-Seleccionar-</option>
