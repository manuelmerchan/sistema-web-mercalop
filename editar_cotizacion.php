...
$id=$_REQUEST['id'];
// $consulta=mysqli_query($con,"SELECT * from cotizacion C inner join clientes CL on CL.id_clientes=C.id_clientes inner join servicios S on S.id_servicios=C.id_servicios where C.id_cotizacion='$id'");
$consulta=mysqli_query($con,"SELECT * from cotizacion C inner join servicios S on S.id_servicios=C.id_servicios where C.id_cotizacion='$id'");
$row=mysqli_fetch_array($consulta);
$num_f=$row['num_cotizacion'];
$idcliente=$row['id_clientes'];

$consCliente=mysqli_query($con,"SELECT * FROM clientes WHERE cedula='$idcliente'");
$rowCliente=mysqli_fetch_array($consCliente);
...
<div class="container delimitador">
  <div class="contenedor">
                ...
                <form class="form" action="app/modificarCotizacion.php?id=<?php echo $id; ?>" method="POST" enctype="multipart/form-data">
                    <div class="form_header">
                        <h2 class="form_titulo">EDITAR COTIZACIÓN</h2>
                    </div>
      ...
      $(function() {
        $("#clientes").customselect();
                      ...
                      <div class="col-md-12 content_cajas">
                            ...
                            <select class="form_input custom-select" id="clientes" name="clientes" required><option value="" >-Seleccionar-</option>
                              <?php $consulta4=mysqli_query($con,"SELECT * from clientes where id_clientes!='1' order by apellidos ASC");
                                while($row4=mysqli_fetch_array($consulta4)){
                                if($row4['id_clientes']==$rowCliente['id_clientes']){$sel="selected='selected'";}else{$sel="";}
                        ...
                        <div class="col-md-4 content_cajas_cotiza">
                            ...
                            <input class="form_input input_cotiza" type="text" id="cedula" name="cedula" value="<?php echo $rowCliente['cedula']; ?>" readonly required>
                        </div>
                        <div class="col-md-4 content_cajas_cotiza">
                            <label class="form_label" for="nombres">Nombres :</label>
                            <input class="form_input input_cotiza" type="text" id="nombres" name="nombres" value="<?php echo $rowCliente['nombres']." ".$rowCliente['apellidos']; ?>" readonly required>
                        </div>
                        <div class="col-md-4 content_cajas_cotiza">
                            <label class="form_label" for="telefono">Teléfono :</label>
                            <input class="form_input input_cotiza" type="text" id="telefono" name="telefono" value="<?php echo $rowCliente['telefono']; ?>" required onkeypress="return enable(event)">
                        </div>
                        <div class="col-md-6 content_cajas_cotiza">
                            <label class="form_label" for="correo">Correo:</label>
                            <input class="form_input input_cotiza" type="text" id="correo" name="correo" value="<?php echo $rowCliente['correo']; ?>" readonly required>
                        </div>
                        <div class="col-md-6 content_cajas_cotiza">
                            <label class="form_label" for="direccion">Dirección:</label>
                            <input class="form_input input_cotiza" type="text" id="direccion" name="direccion" value="<?php echo $rowCliente['direccion']; ?>" readonly required>
                        </div>
                    </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4 content_cajas">
                          <label class="form_label" for="nfactura">Nº Cotización:</label>
                          <input class="form_input" type="text" id="nfactura" name="nfactura" value="<?php echo $num_f; ?>" placeholder="Escriba Nº Factura" readonly>
                      </div>
<script>
$(function() {
  $("#servicios").customselect();
                      ...
                      <div class="col-md-8 content_cajas">
                          ...
                          <select class="form_input custom-select" id="servicios" name="servicios" required><option value="" >-Seleccionar-</option>
                            <?php $consulta4=mysqli_query($con,"SELECT * from servicios order by descrip_s ASC");
                              while($row4=mysqli_fetch_array($consulta4)){
                                if($row4['id_servicios']==$row['id_servicios']){$sel="selected='selected'";}else{$sel="";}
                              echo "<option ".$sel." value='".$row4['id_servicios']."'>"; echo $row4['descrip_s']; echo "</option>"; } ?> </select>
                      </div>
                    ...
                    <div class="">
                      <div class="col-md-4  content_cajas_cotiza">
                          ...
                          <input class="form_input input_cotiza" type="text" id="subtotal" name="subtotal" value="<?php echo $row['sub_total']; ?>" readonly required>
                      </div>
                      <?php
                      ...
                      <div class="col-md-4 content_cajas_cotiza">
                          ...
                          <input class="form_input input_cotiza" type="text" id="iva" name="iva" value="<?php echo $row['iva']; ?>" readonly required>
                      </div>
                      <div class="col-md-4 content_cajas_cotiza">
                          <label class="form_label" for="totalp">TOTAL:</label>
                          <input class="form_input input_cotiza" type="text" id="totalp" name="totalp" value="<?php echo $row['total_pagar']; ?>" readonly required>
                      </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <a href="buscar_cotizacion.php"> <button type="button" class="btn_cancel" name="button">CANCELAR</button> </a>
                        </div>
                    </div>
                </form>
