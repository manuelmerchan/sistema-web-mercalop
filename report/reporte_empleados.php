...
if($estado=="todos"){
    $consulta=mysqli_query($con,"SELECT * FROM empleados E INNER JOIN estado ES ON ES.id_estado=E.id_estado WHERE E.fecha BETWEEN '$inicio' and '$fin' ORDER BY id_empleados DESC");
}elseif ($estado=="activos") {
    $consulta=mysqli_query($con,"SELECT * FROM empleados E INNER JOIN estado ES ON ES.id_estado=E.id_estado WHERE E.fecha BETWEEN '$inicio' and '$fin' and E.id_estado=1 ORDER BY id_empleados DESC");
}else{
    $consulta=mysqli_query($con,"SELECT * FROM empleados E INNER JOIN estado ES ON ES.id_estado=E.id_estado WHERE E.fecha BETWEEN '$inicio' and '$fin' and E.id_estado=2 ORDER BY id_empleados DESC");
}
